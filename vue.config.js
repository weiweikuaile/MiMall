module.exports = {
  ...
  // lintOnSave:false,//eslint校验 默认禁用 true开启可用来错误在开发时直接显示在浏览器中
  productionSourceMap:false//生产环境的 source map不需要时用false，需要时用true,重新打包构建后,可以查看dist文件夹-》js文件夹里出现source map文件,
